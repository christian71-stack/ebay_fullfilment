# cbdesk\ebay_fullfilment\OrderApi
...
# **getOrder**
> \cbdesk\ebay_fullfilment\Model\Order getOrder($field_groups, $order_id)
...
$apiInstance = new cbdesk\ebay_fullfilment\\OrderApi(
...
try {
    $result = $apiInstance->getOrder($field_groups, $order_id);
    print_r($result);
} catch (Exception $e) {
...
[**\cbdesk\ebay_fullfilment\Model\Order**](../Model/Order.md)
...
# **getOrders**
> \cbdesk\ebay_fullfilment\Model\OrderSearchPagedCollection getOrders($field_groups, $filter, $limit, $offset, $order_ids)
...
[**\cbdesk\ebay_fullfilment\Model\OrderSearchPagedCollection**](../Model/OrderSearchPagedCollection.md)
...
# **issueRefund**
> \cbdesk\ebay_fullfilment\Model\Refund issueRefund($order_id, $body)
...
$body = new \cbdesk\ebay_fullfilment\Model\IssueRefundRequest(); // \cbdesk\ebay_fullfilment\Model\IssueRefundRequest | 
 ...
 **body** | [**\cbdesk\ebay_fullfilment\Model\IssueRefundRequest**](../Model/IssueRefundRequest.md)|  | [optional]

### Return type

[**\cbdesk\ebay_fullfilment\Model\Refund**](../Model/Refund.md)
