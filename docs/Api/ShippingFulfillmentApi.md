# cbdesk\ebay_fullfilment\ShippingFulfillmentApi
...
$apiInstance = new cbdesk\ebay_fullfilment\\ShippingFulfillmentApi(
    // If you want use custom http client, pass your client which implements `GuzzleHttp\ClientInterface`.
    // This is optional, `GuzzleHttp\Client` will be used as default.
    new GuzzleHttp\Client(),
    $config
);
$body = new \cbdesk\ebay_fullfilment\Model\ShippingFulfillmentDetails(); // \cbdesk\ebay_fullfilment\Model\ShippingFulfillmentDetails | fulfillment payload
...
------------- | ------------- | ------------- | -------------
 **body** | [**\cbdesk\ebay_fullfilment\Model\ShippingFulfillmentDetails**](../Model/ShippingFulfillmentDetails.md)| fulfillment payload |
...
> \cbdesk\ebay_fullfilment\Model\ShippingFulfillment getShippingFulfillment($fulfillment_id, $order_id)
...
[**\cbdesk\ebay_fullfilment\Model\ShippingFulfillment**](../Model/ShippingFulfillment.md)
...
> \cbdesk\ebay_fullfilment\Model\ShippingFulfillmentPagedCollection getShippingFulfillments($order_id)
...
[**\cbdesk\ebay_fullfilment\Model\ShippingFulfillmentPagedCollection**](../Model/ShippingFulfillmentPagedCollection.md)
