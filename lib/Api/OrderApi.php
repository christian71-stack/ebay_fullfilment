...
class OrderApi
{
     ...
     * @param string|null $order_ids A comma-separated list of the unique identifiers of the orders to retrieve (maximum 50). If one or more order ID values are specified through the &lt;b&gt;orderIds&lt;/b&gt; query parameter, all other query parameters will be ignored. (optional)
     *
     * @return \cbdesk\ebay_fullfilment\Model\OrderSearchPagedCollection
     *@throws \InvalidArgumentException
     * @throws \cbdesk\ebay_fullfilment\ApiException on non-2xx response
     */
    public function getOrders(?string $field_groups = null, ?string $filter = null, ?string $limit = null, ?string $offset = null, ?string $order_ids = null): \cbdesk\ebay_fullfilment\Model\OrderSearchPagedCollection
    {
     ...
     * @throws \cbdesk\ebay_fullfilment\ApiException on non-2xx response
     */
    public function getOrdersWithHttpInfo(?string $field_groups = null, ?string $filter = null, ?string $limit = null, ?string $offset = null, ?string $order_ids = null): array
    {
     ...
     *
     * @param  string $order_id The unique identifier of the order. Order IDs are returned in the &lt;b&gt;getOrders&lt;/b&gt; method (and &lt;b&gt;GetOrders&lt;/b&gt; call of Trading API). The &lt;b&gt;issueRefund&lt;/b&gt; method supports the legacy API Order IDs and REST API order IDs. (required)
     * @param  \cbdesk\ebay_fullfilment\Model\IssueRefundRequest $body (optional)
     *
     * @throws \cbdesk\ebay_fullfilment\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     ...
     *@throws \InvalidArgumentException
     */
    public function issueRefundAsyncWithHttpInfo(string $order_id, $body = null)
    {
        $returnType = '\cbdesk\ebay_fullfilment\Model\Refund';
        $request = $this->issueRefundRequest($order_id, $body);
