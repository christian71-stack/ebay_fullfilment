...
class OrderApi
{
     ...
     * @param string|null $field_groups The response type associated with the order. The only presently supported value is &lt;code&gt;TAX_BREAKDOWN&lt;/code&gt;. This type returns a breakdown of tax and fee values associated with the order. (optional)
     *
     * @return \cbdesk\ebay_fullfilment\Model\Order
     *@throws \InvalidArgumentException
     * @throws \cbdesk\ebay_fullfilment\ApiException on non-2xx response
     */
    public function getOrder(string $order_id, ?string $field_groups = null)
    {
     ...
     * @throws \cbdesk\ebay_fullfilment\ApiException on non-2xx response
     */
    public function getOrderWithHttpInfo(string $order_id, ?string $field_groups = null): array
    {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\cbdesk\ebay_fullfilment\Model\Order',
     ...
     *@throws \InvalidArgumentException
     */
    public function getOrderAsync(string $order_id, ?string $field_groups = null)
    {
     ...
     *@throws \InvalidArgumentException
     */
    public function getOrderAsyncWithHttpInfo(string $order_id, ?string $field_groups = null)
    {
        $returnType = '\cbdesk\ebay_fullfilment\Model\Order';
        $request = $this->getOrderRequest($order_id, $field_groups);
     ...
     *@throws \InvalidArgumentException
     */
    protected function getOrderRequest(string $order_id, ?string $field_groups = null)
    {
     ...
     *
     * @return \cbdesk\ebay_fullfilment\Model\OrderSearchPagedCollection
     *@throws \InvalidArgumentException
     * @throws \cbdesk\ebay_fullfilment\ApiException on non-2xx response
     */
    public function getOrders(?string $field_groups = null, ?string $filter = null, ?string $limit = null, ?string $offset = null, ?string $order_ids = null)
    {
     ...
     * @param  string $order_ids A comma-separated list of the unique identifiers of the orders to retrieve (maximum 50). If one or more order ID values are specified through the &lt;b&gt;orderIds&lt;/b&gt; query parameter, all other query parameters will be ignored. (optional)
     *
     * @return array of \cbdesk\ebay_fullfilment\Model\OrderSearchPagedCollection, HTTP status code, HTTP response headers (array of strings)
     *@throws \InvalidArgumentException
     * @throws \cbdesk\ebay_fullfilment\ApiException on non-2xx response
     */
    public function getOrdersWithHttpInfo(?string $field_groups = null, ?string $filter = null, ?string $limit = null, ?string $offset = null, ?string $order_ids = null)
    {
        $returnType = '\cbdesk\ebay_fullfilment\Model\OrderSearchPagedCollection';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\cbdesk\ebay_fullfilment\Model\OrderSearchPagedCollection',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     *@throws \InvalidArgumentException
     */
    public function getOrdersAsync(?string $field_groups = null, ?string $filter = null, ?string $limit = null, ?string $offset = null, ?string $order_ids = null)
    {
     ...
     *@throws \InvalidArgumentException
     */
    public function getOrdersAsyncWithHttpInfo(?string $field_groups = null, ?string $filter = null, ?string $limit = null, ?string $offset = null, ?string $order_ids = null)
    {
        $returnType = '\cbdesk\ebay_fullfilment\Model\OrderSearchPagedCollection';
        $request = $this->getOrdersRequest($field_groups, $filter, $limit, $offset, $order_ids);
     ...
     *@throws \InvalidArgumentException
     */
    protected function getOrdersRequest(?string $field_groups = null, ?string $filter = null, ?string $limit = null, ?string $offset = null, ?string $order_ids = null)
    {
     ...
     * @param  \cbdesk\ebay_fullfilment\Model\IssueRefundRequest $body body (optional)
     *
     * @throws \cbdesk\ebay_fullfilment\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \cbdesk\ebay_fullfilment\Model\Refund
     */
     ...
     *
     * @param  string $order_id The unique identifier of the order. Order IDs are returned in the &lt;b&gt;getOrders&lt;/b&gt; method (and &lt;b&gt;GetOrders&lt;/b&gt; call of Trading API). The &lt;b&gt;issueRefund&lt;/b&gt; method supports the legacy API Order IDs and REST API order IDs. (required)
     * @param \cbdesk\ebay_fullfilment\Model\IssueRefundRequest|null $body (optional)
     *
     * @return array of \cbdesk\ebay_fullfilment\Model\Refund, HTTP status code, HTTP response headers (array of strings)
     *@throws \InvalidArgumentException
     * @throws \cbdesk\ebay_fullfilment\ApiException on non-2xx response
     */
    public function issueRefundWithHttpInfo($order_id, ?\cbdesk\ebay_fullfilment\Model\IssueRefundRequest $body = null): array
    {
        $returnType = '\cbdesk\ebay_fullfilment\Model\Refund';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\cbdesk\ebay_fullfilment\Model\Refund',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     *@throws \InvalidArgumentException
     */
    public function issueRefundAsync(string $order_id, ?\cbdesk\ebay_fullfilment\Model\IssueRefundRequest $body = null)
    {
     ...
     *@throws \InvalidArgumentException
     */
    public function issueRefundAsyncWithHttpInfo(string $order_id, ?\cbdesk\ebay_fullfilment\Model\IssueRefundRequest $body = null): \GuzzleHttp\Promise\PromiseInterface
    {
        $returnType = '\cbdesk\ebay_fullfilment\Model\Refund';
        $request = $this->issueRefundRequest($order_id, $body);
     ...
     *@throws \InvalidArgumentException
     */
    protected function issueRefundRequest(string $order_id, ?\cbdesk\ebay_fullfilment\Model\IssueRefundRequest $body = null): \GuzzleHttp\Psr7\Request
    {
        // verify the required parameter 'order_id' is set
        if ($order_id === null || (is_array($order_id) && count($order_id) === 0)) {
            throw new \InvalidArgumentException(
