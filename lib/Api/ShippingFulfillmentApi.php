...
class ShippingFulfillmentApi
{
     ...
     *
     * @param  \cbdesk\ebay_fullfilment\Model\ShippingFulfillmentDetails $body fulfillment payload (required)
     ...
     * @throws \cbdesk\ebay_fullfilment\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \cbdesk\ebay_fullfilment\Model\ShippingFulfillment
     */
     ...
     * @throws \cbdesk\ebay_fullfilment\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \cbdesk\ebay_fullfilment\Model\ShippingFulfillment, HTTP status code, HTTP response headers (array of strings)
     */
    public function getShippingFulfillmentWithHttpInfo($fulfillment_id, $order_id)
    {
        $returnType = '\cbdesk\ebay_fullfilment\Model\ShippingFulfillment';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\cbdesk\ebay_fullfilment\Model\ShippingFulfillment',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @throws \cbdesk\ebay_fullfilment\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \cbdesk\ebay_fullfilment\Model\ShippingFulfillmentPagedCollection
     */
     ...
     * @throws \cbdesk\ebay_fullfilment\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \cbdesk\ebay_fullfilment\Model\ShippingFulfillmentPagedCollection, HTTP status code, HTTP response headers (array of strings)
     */
    public function getShippingFulfillmentsWithHttpInfo($order_id)
    {
        $returnType = '\cbdesk\ebay_fullfilment\Model\ShippingFulfillmentPagedCollection';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\cbdesk\ebay_fullfilment\Model\ShippingFulfillmentPagedCollection',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
