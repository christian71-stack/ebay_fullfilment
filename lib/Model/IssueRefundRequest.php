...
'comment' => 'string',
'refund_items' => '\cbdesk\ebay_fullfilment\Model\RefundItem[]',
'order_level_refund_amount' => '\cbdesk\ebay_fullfilment\Model\SimpleAmount'    ];
...
'order_level_refund_amount' => 'getOrderLevelRefundAmount'    ];
     ...
     * Gets refund_items
     *
     * @return \cbdesk\ebay_fullfilment\Model\RefundItem[]
     */
     ...
     * Sets refund_items
     *
     * @param \cbdesk\ebay_fullfilment\Model\RefundItem[] $refund_items The <b>refundItems</b> array is only required if the seller is issuing a refund for one or more individual order line items in a multiple line item order. Otherwise, the seller just uses the <b>orderLevelRefundAmount</b> container to specify the amount of the refund for the entire order.
     *
     * @return $this
     */
     ...
     *
     * @param \cbdesk\ebay_fullfilment\Model\SimpleAmount $order_level_refund_amount order_level_refund_amount
     *
     * @return $this
     */
