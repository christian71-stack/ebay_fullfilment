...
class PaymentDisputeActivityHistory implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        'activity' => '\cbdesk\ebay_fullfilment\Model\PaymentDisputeActivity[]'    ];
     ...
     * Gets activity
     *
     * @return \cbdesk\ebay_fullfilment\Model\PaymentDisputeActivity[]
     */
     ...
     * Sets activity
     *
     * @param \cbdesk\ebay_fullfilment\Model\PaymentDisputeActivity[] $activity This array holds all activities of a payment dispute, from creation to resolution. For each activity, the activity type, the actor, and a timestamp is shown. The <strong>getActivities</strong> response is dynamic, and grows with each recorded activity.
     *
     * @return $this
     */
