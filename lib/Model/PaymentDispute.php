...
class PaymentDispute implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        'amount' => '\cbdesk\ebay_fullfilment\Model\SimpleAmount',
'available_choices' => 'string[]',
'buyer_provided' => '\cbdesk\ebay_fullfilment\Model\InfoFromBuyer',
'buyer_username' => 'string',
'closed_date' => 'string',
'evidence' => '\cbdesk\ebay_fullfilment\Model\DisputeEvidence[]',
'evidence_requests' => '\cbdesk\ebay_fullfilment\Model\EvidenceRequest[]',
'line_items' => '\cbdesk\ebay_fullfilment\Model\OrderLineItems[]',
'monetary_transactions' => '\cbdesk\ebay_fullfilment\Model\MonetaryTransaction[]',
'open_date' => 'string',
'order_id' => 'string',
'payment_dispute_id' => 'string',
'payment_dispute_status' => 'string',
'reason' => 'string',
'resolution' => '\cbdesk\ebay_fullfilment\Model\PaymentDisputeOutcomeDetail',
'respond_by_date' => 'string',
'return_address' => '\cbdesk\ebay_fullfilment\Model\ReturnAddress',
'revision' => 'int',
...
'seller_response' => 'getSellerResponse'    ];
     ...
     * Gets amount
     *
     * @return \cbdesk\ebay_fullfilment\Model\SimpleAmount
     */
     ...
     * Sets amount
     *
     * @param \cbdesk\ebay_fullfilment\Model\SimpleAmount $amount amount
     *
     * @return $this
     */
     ...
     * Gets buyer_provided
     *
     * @return \cbdesk\ebay_fullfilment\Model\InfoFromBuyer
     */
     ...
     * Sets buyer_provided
     *
     * @param \cbdesk\ebay_fullfilment\Model\InfoFromBuyer $buyer_provided buyer_provided
     *
     * @return $this
     */
     ...
     * Gets evidence
     *
     * @return \cbdesk\ebay_fullfilment\Model\DisputeEvidence[]
     */
     ...
     *
     * @return \cbdesk\ebay_fullfilment\Model\EvidenceRequest[]
     */
     ...
     *
     * @param \cbdesk\ebay_fullfilment\Model\EvidenceRequest[] $evidence_requests This container is returned if one or more evidence documents are being requested from the seller.
     *
     * @return $this
     */
     ...
     * Sets line_items
     *
     * @param \cbdesk\ebay_fullfilment\Model\OrderLineItems[] $line_items This array is used to identify one or more order line items associated with the payment dispute. There will always be at least one <b>itemId</b>/<b>lineItemId</b> pair returned in this array.
     *
     * @return $this
     */
     ...
     *
     * @return \cbdesk\ebay_fullfilment\Model\MonetaryTransaction[]
     */
     ...
     *
     * @param \cbdesk\ebay_fullfilment\Model\MonetaryTransaction[] $monetary_transactions This array provide details about one or more monetary transactions that occur as part of a payment dispute. This array is only returned once one or more monetary transacations occur with a payment dispute.
     *
     * @return $this
     */
     ...
     * Gets resolution
     *
     * @return \cbdesk\ebay_fullfilment\Model\PaymentDisputeOutcomeDetail
     */
     ...
     * Sets resolution
     *
     * @param \cbdesk\ebay_fullfilment\Model\PaymentDisputeOutcomeDetail $resolution resolution
     *
     * @return $this
     */
     ...
     * Gets return_address
     *
     * @return \cbdesk\ebay_fullfilment\Model\ReturnAddress
     */
     ...
     * Sets return_address
     *
     * @param \cbdesk\ebay_fullfilment\Model\ReturnAddress $return_address return_address
     *
     * @return $this
     */
