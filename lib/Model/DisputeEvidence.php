...
'files' => '\cbdesk\ebay_fullfilment\Model\FileInfo[]',
'line_items' => '\cbdesk\ebay_fullfilment\Model\OrderLineItems[]',
'provided_date' => 'string',
'request_date' => 'string',
'respond_by_date' => 'string',
'shipment_tracking' => '\cbdesk\ebay_fullfilment\Model\TrackingInfo[]'    ];
...
'shipment_tracking' => 'getShipmentTracking'    ];
     ...
     * Gets files
     *
     * @return \cbdesk\ebay_fullfilment\Model\FileInfo[]
     */
     ...
     * Sets files
     *
     * @param \cbdesk\ebay_fullfilment\Model\FileInfo[] $files This array shows the name, ID, file type, and upload date for each provided file.
     *
     * @return $this
     */
     ...
     *
     * @return \cbdesk\ebay_fullfilment\Model\TrackingInfo[]
     */
     ...
     *
     * @param \cbdesk\ebay_fullfilment\Model\TrackingInfo[] $shipment_tracking This array shows the shipping carrier and shipment tracking number associated with each shipment package of the order. This array is returned if the seller has provided shipment tracking information as evidence to support <code>PROOF_OF_DELIVERY</code>.
     *
     * @return $this
     */
