...
class PaymentSummary implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        'payments' => '\cbdesk\ebay_fullfilment\Model\Payment[]',
'refunds' => '\cbdesk\ebay_fullfilment\Model\OrderRefund[]',
'total_due_seller' => '\cbdesk\ebay_fullfilment\Model\Amount'    ];
...
'total_due_seller' => 'getTotalDueSeller'    ];
     ...
     * Gets payments
     *
     * @return \cbdesk\ebay_fullfilment\Model\Payment[]
     */
     ...
     * Gets refunds
     *
     * @return \cbdesk\ebay_fullfilment\Model\OrderRefund[]
     */
     ...
     * Sets refunds
     *
     * @param \cbdesk\ebay_fullfilment\Model\OrderRefund[] $refunds This array is always returned, but is returned as an empty array unless the seller has submitted a partial or full refund to the buyer for the order. If a refund has occurred, the refund amount and refund date will be shown for each refund.
     *
     * @return $this
     */
     ...
     *
     * @param \cbdesk\ebay_fullfilment\Model\Amount $total_due_seller total_due_seller
     *
     * @return $this
     */
