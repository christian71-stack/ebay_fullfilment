...
'payment_date' => 'string',
'payment_holds' => '\cbdesk\ebay_fullfilment\Model\PaymentHold[]',
...
'payment_status' => 'getPaymentStatus'    ];
     ...
     * Gets payment_holds
     *
     * @return \cbdesk\ebay_fullfilment\Model\PaymentHold[]
     */
     ...
     * Sets payment_holds
     *
     * @param \cbdesk\ebay_fullfilment\Model\PaymentHold[] $payment_holds This container is only returned if eBay is temporarily holding the seller's funds for the order. If a payment hold has been placed on the order, this container includes the reason for the payment hold, the expected release date of the funds into the seller's account, the current state of the hold, and as soon as the payment hold has been released, the actual release date.
     *
     * @return $this
     */
