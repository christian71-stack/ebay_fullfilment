...
class LineItem implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        'applied_promotions' => '\cbdesk\ebay_fullfilment\Model\AppliedPromotion[]',
'delivery_cost' => '\cbdesk\ebay_fullfilment\Model\DeliveryCost',
'discounted_line_item_cost' => '\cbdesk\ebay_fullfilment\Model\Amount',
'ebay_collect_and_remit_taxes' => '\cbdesk\ebay_fullfilment\Model\EbayCollectAndRemitTax[]',
'ebay_collected_charges' => '\cbdesk\ebay_fullfilment\Model\EbayCollectedCharges',
'gift_details' => '\cbdesk\ebay_fullfilment\Model\GiftDetails',
'item_location' => '\cbdesk\ebay_fullfilment\Model\ItemLocation',
'legacy_item_id' => 'string',
'legacy_variation_id' => 'string',
'line_item_cost' => '\cbdesk\ebay_fullfilment\Model\Amount',
'line_item_fulfillment_instructions' => '\cbdesk\ebay_fullfilment\Model\LineItemFulfillmentInstructions',
'line_item_fulfillment_status' => 'string',
'line_item_id' => 'string',
'listing_marketplace_id' => 'string',
'properties' => '\cbdesk\ebay_fullfilment\Model\LineItemProperties',
'purchase_marketplace_id' => 'string',
'quantity' => 'int',
'refunds' => '\cbdesk\ebay_fullfilment\Model\LineItemRefund[]',
'sku' => 'string',
'sold_format' => 'string',
'taxes' => '\cbdesk\ebay_fullfilment\Model\Tax[]',
'title' => 'string',
'total' => '\cbdesk\ebay_fullfilment\Model\Amount'    ];
...
'total' => 'getTotal'    ];
     ...
     *
     * @return \cbdesk\ebay_fullfilment\Model\AppliedPromotion[]
     */
     ...
     *
     * @param \cbdesk\ebay_fullfilment\Model\AppliedPromotion[] $applied_promotions This array contains information about one or more sales promotions or discounts applied to the line item. It is always returned, but will be returned as an empty array if no special sales promotions or discounts apply to the order line item.
     *
     * @return $this
     */
     ...
     * Gets delivery_cost
     *
     * @return \cbdesk\ebay_fullfilment\Model\DeliveryCost
     */
     ...
     * Sets delivery_cost
     *
     * @param \cbdesk\ebay_fullfilment\Model\DeliveryCost $delivery_cost delivery_cost
     *
     * @return $this
     */
     ...
     *
     * @param \cbdesk\ebay_fullfilment\Model\Amount $discounted_line_item_cost discounted_line_item_cost
     *
     * @return $this
     */
     ...
     *
     * @return \cbdesk\ebay_fullfilment\Model\EbayCollectAndRemitTax[]
     */
     ...
     *
     * @return \cbdesk\ebay_fullfilment\Model\EbayCollectedCharges
     */
     ...
     *
     * @param \cbdesk\ebay_fullfilment\Model\EbayCollectedCharges $ebay_collected_charges ebay_collected_charges
     *
     * @return $this
     */
     ...
     * Gets gift_details
     *
     * @return \cbdesk\ebay_fullfilment\Model\GiftDetails
     */
     ...
     * Sets gift_details
     *
     * @param \cbdesk\ebay_fullfilment\Model\GiftDetails $gift_details gift_details
     *
     * @return $this
     */
     ...
     * Gets item_location
     *
     * @return \cbdesk\ebay_fullfilment\Model\ItemLocation
     */
     ...
     * Sets item_location
     *
     * @param \cbdesk\ebay_fullfilment\Model\ItemLocation $item_location item_location
     *
     * @return $this
     */
     ...
     * Sets line_item_cost
     *
     * @param \cbdesk\ebay_fullfilment\Model\Amount $line_item_cost line_item_cost
     *
     * @return $this
     */
     ...
     *
     * @return \cbdesk\ebay_fullfilment\Model\LineItemFulfillmentInstructions
     */
     ...
     *
     * @param \cbdesk\ebay_fullfilment\Model\LineItemFulfillmentInstructions $line_item_fulfillment_instructions line_item_fulfillment_instructions
     *
     * @return $this
     */
     ...
     * Gets properties
     *
     * @return \cbdesk\ebay_fullfilment\Model\LineItemProperties
     */
     ...
     * Sets properties
     *
     * @param \cbdesk\ebay_fullfilment\Model\LineItemProperties $properties properties
     *
     * @return $this
     */
     ...
     * Gets refunds
     *
     * @return \cbdesk\ebay_fullfilment\Model\LineItemRefund[]
     */
     ...
     * Sets refunds
     *
     * @param \cbdesk\ebay_fullfilment\Model\LineItemRefund[] $refunds This array is always returned, but is returned as an empty array unless the seller has submitted a partial or full refund to the buyer for the order. If a refund has occurred, the refund amount and refund date will be shown for each refund.
     *
     * @return $this
     */
     ...
     * Gets taxes
     *
     * @return \cbdesk\ebay_fullfilment\Model\Tax[]
     */
     ...
     * Sets taxes
     *
     * @param \cbdesk\ebay_fullfilment\Model\Tax[] $taxes Contains a list of taxes applied to the line item, if any. This array is always returned, but will be returned as empty if no taxes are applicable to the line item.
     *
     * @return $this
     */
     ...
     * Sets total
     *
     * @param \cbdesk\ebay_fullfilment\Model\Amount $total total
     *
     * @return $this
     */
