...
'parameters' => '\cbdesk\ebay_fullfilment\Model\ErrorParameter[]',
'subdomain' => 'string'    ];
...
'subdomain' => 'getSubdomain'    ];
     ...
     * Gets parameters
     *
     * @return \cbdesk\ebay_fullfilment\Model\ErrorParameter[]
     */
     ...
     * Sets parameters
     *
     * @param \cbdesk\ebay_fullfilment\Model\ErrorParameter[] $parameters Contains a list of name/value pairs that provide additional information concerning this error or warning. Each item in the list is an input parameter that contributed to the error or warning condition.
     *
     * @return $this
     */
